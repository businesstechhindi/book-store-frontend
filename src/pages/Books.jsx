    ...
    if (userData) {
      if (!preventUser) {
        ...
        if (item.wishList.includes(user)) {
          axios
            .post(
              "https://book-store-server-05l0.onrender.com/remove-from-wishlist",
              {
                item: item._id,
                user,
              },
          ...
          axios
            .post(
              "https://book-store-server-05l0.onrender.com/add-to-wishlist",
              {
                item,
                user,
              },
  ...
  const handleAddToCart = (item, user) => {
    if (userData) {
      if (!preventUser) {
        ...
        axios
          .post(
            "https://book-store-server-05l0.onrender.com/add-to-cart",
            {
              item,
              user,
            },
