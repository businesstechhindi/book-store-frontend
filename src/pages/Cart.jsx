...
const Cart = () => {
  ...
  const increaseOrderQuantity = (bookId, userId) => {
    if (!preventUser) {
      axios
        .post(
          "https://book-store-server-05l0.onrender.com/increase-cart-quantity",
          {
            bookId,
            userId,
          },
  ...
  const decreaseOrderQuantity = (bookId, userId) => {
    if (!preventUser) {
      axios
        .post(
          "https://book-store-server-05l0.onrender.com/decrease-cart-quantity",
          {
            bookId,
            userId,
          },
  ...
  const handlePayNow = (e) => {
    ...
    if (userData) {
      if (!preventUser) {
        ...
        axios
          .post(
            "https://book-store-server-05l0.onrender.com/orders",
            {
              orders,
            },
            {
  ...
  useEffect(() => {
    window.scrollTo(0, 0);
    axios
      .get("https://book-store-server-05l0.onrender.com/user-auth")
      .then((res) => {
        if (res.data.success) {
  ...
  const removeFromCart = (item, user) => {
    if (userData) {
      if (!preventUser) {
        ...
        axios
          .post(
            "https://book-store-server-05l0.onrender.com/remove-from-cart",
            {
              item,
              user,
            },
