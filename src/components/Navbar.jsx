...
const Navbar = () => {
  ...
  const logoutUser = () => {
    axios
      .get("https://book-store-server-05l0.onrender.com/logout-user")
      .then((res) => {
        if (res.data.success) {
  ...
  const registerUser = (e) => {
    ...
    if (password !== confirmPassword) {
      ...
      axios
        .post(
          "https://book-store-server-05l0.onrender.com/register-user",
          {
            firstName,
            lastName,
            email,
  ...
  const loginUser = (e) => {
    ...
    axios
      .post(
        "https://book-store-server-05l0.onrender.com/login-user",
        {
          email,
          password,
        },
